...
\title{\Large\textbf{College Mentorship Management System (CMMS):}\\[0.2em]
\Large\textbf{A Digital Platform for Faculty--Student Mentorship}}
\author{
  \relax Aaditya Bansal \\ \small 1024030768 \\[0.3em]
  \relax Jessica \\ \small 1024030761 \\[0.3em]
  \relax Harshveer Singh \\ \small 1024030776 \\[0.3em]
  \small Department of Computer Science and Engineering \\
  \small Thapar Institute of Engineering and Technology
}
\date{Submitted to: Jeelani Asif \\ Course: UCS503P \\ August 18, 2026}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{usecase.png}
\caption{Use-case diagram: actors and their interactions with CMMS.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{dfd_level0.png}
\caption{DFD Level 0 (context diagram): CMMS as a single process.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{dfd_level1.png}
...
12 & \textbf{Buffer week:} fixes from pilot feedback, final polish and docs & Final submission \\
\bottomrule
\end{tabular}
\end{center}
